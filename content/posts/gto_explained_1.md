...
$$0 = \left(\frac{\text{frac\_facing\_AA\_given\_p1\_bets}}{1} \times (-1) + \frac{\text{frac\_facing\_QQ\_given\_p1\_bets}}{1} \times 2\right)$$
...
Larger bets are paired with higher bluff frequencies, and and also lower calling frequencies. **But your perfectly polar hands still make more money by betting large in theory!** This is a general pattern that is important to remember.
...
All this was pretty neat but maybe doesn't give that much practical advice on what to do in any hands yet. Nevertheless, these concepts are so foundatational that I think it makes sense as the first of the 25 hours of study, and I'll focus on more practical advice for the next 24 of them!
